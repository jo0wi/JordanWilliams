...
HD_PWD='C:/Users/jorda/HDL/Digital_Design_Labs/TBird_Turnsignal/TBird_Turnsignal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_FSM_1Hz_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TB_FSM_1Hz_Top.tcl
