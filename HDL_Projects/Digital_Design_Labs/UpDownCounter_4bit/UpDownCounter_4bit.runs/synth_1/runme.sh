...
HD_PWD='C:/Users/jorda/HDL/Digital_Design_Labs/UpDownCounter_4bit/UpDownCounter_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UD_Counter_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UD_Counter_Top.tcl
