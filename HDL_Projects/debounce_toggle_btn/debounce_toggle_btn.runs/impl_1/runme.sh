...
HD_PWD='C:/Users/jorda/HDL/HDL-1/debounce_toggle_btn/debounce_toggle_btn.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log toggle_btn.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source toggle_btn.tcl -notrace
