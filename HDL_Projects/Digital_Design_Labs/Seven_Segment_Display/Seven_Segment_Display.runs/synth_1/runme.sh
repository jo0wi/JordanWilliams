...
HD_PWD='C:/Users/jorda/HDL/Seven_Segment_Display/Seven_Segment_Display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder7Seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decoder7Seg.tcl
