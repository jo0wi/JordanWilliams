...
const char topic_status[] = "elee2045/finalproj/light_status";
const char topic_control_color[] = "elee2045/finalproj/light_control_color";
const char topic_control_status[] = "elee2045/finalproj/light_control_status";
char buffer[100];
int r;
int g;
int b;
