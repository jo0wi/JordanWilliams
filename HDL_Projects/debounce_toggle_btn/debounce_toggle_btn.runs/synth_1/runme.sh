...
HD_PWD='C:/Users/jorda/HDL/HDL-1/debounce_toggle_btn/debounce_toggle_btn.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toggle_btn.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toggle_btn.tcl
