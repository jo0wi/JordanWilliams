...
HD_PWD='C:/Users/jorda/HDL/primative_gates/primative_gates.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OR2_Gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OR2_Gate.tcl -notrace
