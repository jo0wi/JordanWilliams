...
HD_PWD='C:/JordanWilliams/HDL_Projects/UART_Interface_ESP_32/UART_Interface_ESP_32.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_UART_RXTX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_UART_RXTX.tcl -notrace
