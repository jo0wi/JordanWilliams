...
HD_PWD='C:/Users/jorda/HDL/Seven_Segment_Display/Seven_Segment_Display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder7Seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Decoder7Seg.tcl -notrace
