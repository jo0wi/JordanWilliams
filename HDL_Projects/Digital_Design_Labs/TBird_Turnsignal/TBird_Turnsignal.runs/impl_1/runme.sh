...
HD_PWD='C:/Users/jorda/HDL/Digital_Design_Labs/TBird_Turnsignal/TBird_Turnsignal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_FSM_1Hz_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TB_FSM_1Hz_Top.tcl -notrace
