...
HD_PWD='C:/Users/jorda/HDL/Digital_Design_Labs/UpDownCounter_4bit/UpDownCounter_4bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UD_Counter_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UD_Counter_Top.tcl -notrace
