...
HD_PWD='C:/Users/jorda/HDL/primative_gates/primative_gates.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OR2_Gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OR2_Gate.tcl
