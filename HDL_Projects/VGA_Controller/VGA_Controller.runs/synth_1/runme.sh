...
HD_PWD='C:/JordanWilliams/HDL_Projects/VGA_Controller/VGA_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_VGAdisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_VGAdisplay.tcl
