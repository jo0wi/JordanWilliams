...
HD_PWD='C:/JordanWilliams/HDL_Projects/UART_Interface_ESP_32/UART_Interface_ESP_32.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_UART_RXTX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_UART_RXTX.tcl
